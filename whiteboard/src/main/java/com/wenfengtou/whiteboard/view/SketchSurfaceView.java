...
public class SketchSurfaceView extends SurfaceView implements View.OnTouchListener {
    ...
    public SketchSurfaceView(Context context, AttributeSet attrs, int defStyleAttr) {
